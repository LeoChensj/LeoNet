...
@implementation LeoNetworkPrivate
...
+ (void)addDoNotBackupAttribute:(NSString *)path
{
    ...
    if (error)
    {
        LeoLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation LeoBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack
{
    for (id<LeoRequestAccessory> accessory in self.requestAccessories)
    {
